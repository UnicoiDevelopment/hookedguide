...
export const metadata: Metadata = {
  title: "Fishing Rig Builder — Build Your Perfect Setup | HOOKED",
  ...
  openGraph: { title: "Fishing Rig Builder | HOOKED", description: "Build your complete fishing rig piece by piece.", url: 'https://hookedguide.com/rig-builder' },
  twitter: { title: "Fishing Rig Builder | HOOKED", description: "Build your complete fishing rig piece by piece." },
};
